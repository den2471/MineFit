...
from src.data.schemas import VersionORM, InvalidVersionORM
...
async def get_versions(id_list: list[str]) -> tuple[tuple[VersionORM, ...], tuple[InvalidVersionORM, ...]]:
    async with Session() as session:
        ...
        return tuple(versions), tuple(inv_versions)
